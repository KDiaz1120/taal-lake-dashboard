...
# Top metrics row - larger and more prominent
col1, col2, col3, col4 = st.columns(4)
with col1:
    st.metric(label="Water Quality Index", value="92.5%", delta="1.3% ▲")
with col2:
    st.metric(label="Samples Collected", value="1,478", delta="3.7% ▲")
with col3:
    st.metric(label="Alert Count", value="14", delta="1.1% ▲")
with col4:
    st.metric(label="Compliance Rate", value="87%", delta="2.1% ▼")
...
with tab6:
    ...
    with col1:
        ...
        try:
            image = Image.open(r"C:\Users\AstiAd\Downloads\491215579_999429189028389_6878600373986600498_n.jpg")
